...
export default {
    ...
    data () {
        return{
            ...
            value: [
                { name: 'GASISTA', code: 'vu' },
                { name: 'PLOMERO', code: 'js' },
                { name: 'ELECTRICISTA', code: 'os' },
                { name: 'PINTOR', code: 'os' },
                { name: 'TECNICO DE AIRE ACONDICIONADO', code: 'os' }       
            ],
            categories: [
                { name: 'GASISTA', code: 'vu' },
                { name: 'PLOMERO', code: 'js' },
    ...
    methods: {       
        async setCategories(){
            debugger;
            await axios.post(`${BASEURL}/providerCategories/create`, {
